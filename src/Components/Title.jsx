...
const Title = ({ data }) => {
  ...
  return (
    <div className="p-4 text-[#f9d3de] font-semibold h-full fixed bg-transparent flex flex-col z-0">
      ...
      <h1 className="text-9xl bg-transparent z-0">
        <TextScramble
          autoStart
          text={data?.name || ""}
          autostart
          characters="abcdejklmnopqrst#@$%^&()ST" // Scramble text using numbers only
          speed={200}
          scrambleSpeed={90}
          revealText
          revealSpeed={100}
      ...
      <h3 className="text-4xl bg-transparent flex items-end h-full leading-8 z-0">
